...
public class PlantUmlSequenceDiagramGeneratorTest {
    ...
    public void should_addASequence_forEachFeatureCallResults() throws Exception {
        FixtureCallResult  fixtureCallResult1 = new FixtureCallResult(new FixtureCall(null, "name1",12,new Fixture(getMethod1(),null),new ArrayList<String>(),0), Issue.SUCCEEDED);
        FixtureCallResult  fixtureCallResult2 = new FixtureCallResult(new FixtureCall(null, "name2",12,new Fixture(getMethod2(),null),new ArrayList<String>(),0), Issue.SUCCEEDED);
    ...
    public void should_addASequenceColor_dependingTheIssue() throws Exception {
        FixtureCallResult  fixtureCallResult1 = new FixtureCallResult(new FixtureCall(null, "name1",12,new Fixture(getMethod1(),null),new ArrayList<String>(),0), Issue.SUCCEEDED);
        FixtureCallResult  fixtureCallResult2 = new FixtureCallResult(new FixtureCall(null, "name2",12,new Fixture(getMethod2(),null),new ArrayList<String>(),0), Issue.FAILED);
        FixtureCallResult  fixtureCallResult3 = new FixtureCallResult(new FixtureCall(null, "name3",12,new Fixture(getMethod3(),null),new ArrayList<String>(),0), Issue.IGNORED);
