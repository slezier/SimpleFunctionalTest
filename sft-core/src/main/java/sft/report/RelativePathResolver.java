...
public class RelativePathResolver {
    ...
    public  String getRelativePathAsFile(Class originClass,Class targetClass, String extension){
        String source = getPathOf(originClass,extension);
        String target = getPathOf(targetClass,extension);
        return getRelativePathToFile(source, target);
    }
